...
const MovieDetails = () => {
  ...
  const handleDelete = async () => {
    try {
      await axiosInstance.delete(`https://movie-project-frontend.vercel.app/api/movies/${id}`);
      navigate('/');
    } catch (error) {
  ...
  const handleToggleWatchStatus = async () => {
    try {
      await axiosInstance.put(`https://movie-project-frontend.vercel.app/api/movies/${id}`, {
       ...movie,
 ...
 const handleSubmit = async (e) => {
  e.preventDefault();
  try {
    const response = await axiosInstance.post('https://movie-project-frontend.vercel.app/movies', formData);
    // Handle success
  } catch (error) {
    if (error.response) {
